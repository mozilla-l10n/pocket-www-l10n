...
contact-report-security-vulnerability = 若您認為自己在 { -brand-name-pocket } 中發現了安全漏洞，請遵循 { -brand-name-mozilla } 安全頁面上記錄的 <a href="{ $security_bug }">{ -brand-name-mozilla }</a>錯誤報告流程。
# Variables:
