...
contact-to-get-help = 如需 { -brand-name-pocket } 的協助或申請功能，請前往我們的<a href="{ $help }">支援頁面</a>。
contact-press = 新聞
# Variables:
#   $press (url) link to https://getpocket.com/press
contact-for-press-inquiries = 如需新聞查詢或媒體資料，請前往我們的<a href="{ $press }">新聞頁面</a>。
contact-sponsorships-business = 贊助/業務
# Variables:
#   $business_email_link (email link) mailto:business@getpocket.com
#   $business_email (string) business@getpocket.com
contact-related-to-business = 如有業務相關問題，請透過 <a href="{ $business_email_link }">{ $business_email }</a> 聯絡我們。
# Variables:
#   $sponsor_email_link (email link) mailto:sponsor@getpocket.com
#   $sponsor_email (string) sponsor@getpocket.com
contact-related-to-sponsorships = 如有贊助相關問題，請透過 <a href="{ $sponsor_email_link }">{ $sponsor_email }</a> 聯絡我們。
# API = Application Programming Interface
contact-api = API
# Variables:
#   $api_email_link (email link) mailto:api@getpocket.com
#   $api_email (string) sponsor@getpocket.com
contact-regarding-api = 如對我們的 API 有疑問、問題或建議，請透過 <a href="{ $api_email_link }">{ $api_email }</a> 聯絡我們。
contact-jobs = 工作機會
# Variables:
#   $jobs (url) link to https://getpocket.com/jobs
contact-view-job-page = 如要檢視 { -brand-name-pocket } 的所有開放職缺，請前往我們的<a href="{ $jobs }">工作機會頁面</a>。
contact-security = 安全
# Variables:
#   $security_bug (url) link to https://www.mozilla.org/en-US/about/governance/policies/security-group/bugs/
contact-report-security-vulnerability = 若您認為自己在 { -brand-name-pocket } 中發現了安全漏洞，請遵循 <a href="{ $security_bug }">{ -brand-name-mozilla } 安全頁面</a>上記錄的 { -brand-name-mozilla }錯誤報告流程。
# Variables:
#   $security_email_link (email link) mailto:security@getpocket.com
#   $security_email (string) security@getpocket.com
contact-related-to-security = 如有安全相關問題，請透過 <a href="{ $security_email_link }">{ $security_email }</a> 聯絡我們。
contact-follow-us = 關注我們
contact-blog = { -brand-name-pocket } 部落格
# Variables:
...
# HQ = Headquarters
contact-hq = { -brand-name-pocket } 總部
