...
contact-to-get-help = 要获取 { -brand-name-pocket } 方面的帮助或申请功能，请访问我们的<a href="{ $help }">支持页面</a>。
contact-press = 新闻
# Variables:
#   $press (url) link to https://getpocket.com/press
contact-for-press-inquiries = 要查询新闻或媒体资料，请访问我们的<a href="{ $press }">新闻页面</a>。
contact-sponsorships-business = 赞助/业务
# Variables:
#   $business_email_link (email link) mailto:business@getpocket.com
#   $business_email (string) business@getpocket.com
contact-related-to-business = 有关业务方面的问题，请通过 <a href="{ $business_email_link }">{ $business_email }</a> 联系我们。
# Variables:
#   $sponsor_email_link (email link) mailto:sponsor@getpocket.com
#   $sponsor_email (string) sponsor@getpocket.com
contact-related-to-sponsorships = 有关赞助方面的问题，请通过 <a href="{ $sponsor_email_link }">{ $sponsor_email }</a> 联系我们。
# API = Application Programming Interface
contact-api = API
# Variables:
#   $api_email_link (email link) mailto:api@getpocket.com
#   $api_email (string) sponsor@getpocket.com
contact-regarding-api = 如果对我们的 API 有任何疑问、问题或建议，请通过 <a href="{ $api_email_link }">{ $api_email }</a> 联系我们。
contact-jobs = 工作机会
# Variables:
#   $jobs (url) link to https://getpocket.com/jobs
contact-view-job-page = 要查看 { -brand-name-pocket } 的所有招聘职位，请访问我们的<a href="{ $jobs }">工作机会页面</a>。
contact-security = 安全
# Variables:
#   $security_bug (url) link to https://www.mozilla.org/en-US/about/governance/policies/security-group/bugs/
contact-report-security-vulnerability = 如果您认为您在 { -brand-name-pocket } 中发现了一个安全漏洞，请遵循 <a href="{ $security_bug }">Mozilla 安全页面</a>上的 Mozilla 错误报告流程。
# Variables:
#   $security_email_link (email link) mailto:security@getpocket.com
#   $security_email (string) security@getpocket.com
contact-related-to-security = 有关安全方面的问题，请通过 <a href="{ $security_email_link }">{ $security_email }</a> 联系我们。
contact-follow-us = 关注我们
contact-blog = { -brand-name-pocket } 博客
# Variables:
...
# HQ = Headquarters
contact-hq = { -brand-name-pocket } 总部
