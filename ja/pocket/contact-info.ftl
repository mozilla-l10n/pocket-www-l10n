...
contact-report-security-vulnerability = { -brand-name-pocket } をご利用中にセキュリティ上の脆弱性を発見された方は、<a href="{ $security_bug }">Mozilla’s Security ページ</a>に記載の Mozilla バグ報告プロセスに従ってください。
# Variables:
